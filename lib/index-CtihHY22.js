...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    let onConfirmFn;
    const filterOptionsCache = /* @__PURE__ */ new Map();
    onUnmounted(() => {
    ...
    function getFilterOptions(data, col, colIndex) {
      ...
      const rawKey = `__RAW__${dataIndex}`;
    ...
    async function show(pos, filterOptions, data, col, colIndex, onConfirm) {
      if (dropdownEl.value) {
        dropdownEl.value.style.visibility = "hidden";
      }
      visible.value = true;
      if (!(filterOptions == null ? void 0 : filterOptions.length)) {
