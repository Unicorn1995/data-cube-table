                  ...
                  return openBlock(), createElementBlock("tr", { key: footRowIndex }, [
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(virtualX_columnPart), (col) => {
                      return openBlock(), createElementBlock(Fragment, {
                        key: col.type === "spacer" ? "spacer" : colKeyGen.value(col)
                      }, [
                        col.type === "spacer" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                          col.__COLSPAN__ ? (openBlock(), createElementBlock("td", {
                            key: 0,
                            class: "vt-x-spacer",
            ...
            createElementVNode("tbody", {
                ...
                __props.fixedMode && __props.headless ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(virtualX_columnPart), (col) => {
                    return openBlock(), createElementBlock(Fragment, {
                      ...
                      ], 64)) : (openBlock(), createElementBlock("td", {
                        key: 1,
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(virtual_dataSourcePart), (row, rowIndex) => {
                return openBlock(), createElementBlock("tr", mergeProps({
                  ...
                  row && row.__EXP_R__ ? (openBlock(), createElementBlock("td", {
                  ...
                  ], 8, _hoisted_14)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(virtualX_columnPart), (col, colIndex) => {
                      return openBlock(), createElementBlock(Fragment, {
                        ...
                        ], 64)) : !shouldHideCell(row, col) ? (openBlock(), createElementBlock("td", mergeProps({
                          key: 1,
                          ref_for: true
                        }, getTDProps(row, col, rowIndex, col.__LEAF_START__ ?? 0)), [
