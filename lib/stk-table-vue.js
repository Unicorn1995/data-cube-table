 ...
 * license: MIT
 */
import { ref, computed, watch, nextTick, onMounted, onBeforeUnmount, createElementBlock, openBlock, createElementVNode, defineComponent, normalizeStyle, createBlock, createCommentVNode, toDisplayString, shallowRef, customRef, onUnmounted, toRaw, createApp, normalizeClass, triggerRef, provide, toRef, unref, renderSlot, Fragment, renderList, mergeProps, resolveDynamicComponent, withCtx, createTextVNode, createVNode, markRaw, getCurrentInstance, h, withModifiers } from "vue";
...
const useAreaSelection = /* @__PURE__ */ Object.assign(useAreaSelectionImpl, {
...
async function getDropdownIns() {
  if (!DropdownIns) {
    ...
    const DropdownApp = await import("./index-CtihHY22.js").then((module) => module.default);
...
const SILENT_Y_KEYS = ["scrollTop"];
const SILENT_X_KEYS = ["scrollLeft"];
...
function useVirtualScroll(props, tableContainerRef, trRef, dataSourceCopy, tableHeaderLast, tableHeaders, rowKeyGen, maxRowSpan, getMaxRowSpanValue, scrollbarOptions, isExperimentalScrollY, isRelativeMode, mergeCellsCache) {
  ...
  function assignVs(ref2, patch, silentKeys) {
    const store = ref2.value;
    let changed = false;
    for (const key in patch) {
      const k = key;
      if (store[k] !== patch[k]) {
        store[k] = patch[k];
        if (!(silentKeys == null ? void 0 : silentKeys.includes(k))) changed = true;
      }
    }
    if (changed) triggerRef(ref2);
  }
  ...
  function updateVirtualScrollY(sTop = 0) {
    ...
    const rowHeight = getRowHeightFn.value();
    const vsValue = {};
    const totalRowsHeight = props.autoRowHeight || hasExpandCol.value ? getRowHeightTreeCache(dataSourceCopyTemp).tree.total : dataLength * rowHeight;
    ...
    if (autoRowHeight || hasExpandCol.value) {
      ...
      if (autoRowHeight && trRef.value) {
        ...
        const { tree: tree2, keyIndex } = treeCache;
        const heightFn = getRowHeightFn.value;
        for (let i = 0, len = trElements.length; i < len; i++) {
          ...
          if (idx !== void 0 && tr.offsetHeight) tree2.add(idx, tr.offsetHeight - oldHeight);
        }
      }
...
const _hoisted_8 = ["checked", "indeterminate"];
const _hoisted_9 = { class: "table-header-title" };
...
const _hoisted_27 = ["data-above-count"];
const _hoisted_28 = ["data-below-count"];
const __default__ = {
  name: "StkTable"
};
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    function onCellCheckboxChange(row) {
    ...
    const getFormattedValue = (row, col, rowIndex, colIndex) => {
    ...
    watch(
      () => {
        var _a;
        return `${props.rowHeight}|${props.headerRowHeight}|${props.footerRowHeight}|${(_a = props.expandConfig) == null ? void 0 : _a.height}`;
      },
      () => nextTick(initVirtualScrollY)
    );
    watch(
    ...
    function initFilter() {
      ...
      for (let i = 0; i < columns.length; i++) {
        ...
        if (!filterable || !(filterOptions == null ? void 0 : filterOptions.length)) continue;
        const filterValues = [];
    ...
    function filterDataChange(value, column, colIndex) {
      let payload = null;
      if (value.length) {
        payload = {
          value,
                    ...
                    return openBlock(), createElementBlock("th", mergeProps({
                      ...
                      createElementVNode("div", {
                        ...
                        col.customHeaderCell ? (openBlock(), createBlock(resolveDynamicComponent(col.customHeaderCell), {
                          ...
                          colIndex,
                          rowIndex
                        }, null, 8, ["col", "colIndex", "rowIndex"])) : col.type === "selection" ? (openBlock(), createElementBlock("div", _hoisted_7, [
                          ...
                          createElementVNode("span", _hoisted_9, toDisplayString(col.label), 1)
                        ]),
                        col.sorter ? (openBlock(), createBlock(SortIcon, {
                          key: 3,
                          class: "table-header-sorter"
                        })) : createCommentVNode("", true),
                        col.filterable ? (openBlock(), createBlock(_sfc_main$3, {
                          key: 4,
                          theme: __props.theme,
                          active: Boolean((_a = filterStatus.value[col.dataIndex]) == null ? void 0 : _a.value.length),
                        ...
                        }, null, 8, ["theme", "active", "data-source", "options", "col", "col-index", "row", "row-index"])) : createCommentVNode("", true)
                      ], 4),
                  ...
                  return openBlock(), createElementBlock("tr", { key: footRowIndex }, [
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(virtualX_columnPart), (col, _colIdx) => {
                      return openBlock(), createElementBlock(Fragment, {
                        ...
                        col.__VT_C_SP__ ? (openBlock(), createElementBlock("td", {
                        ...
                        }, null, 8, _hoisted_11)) : (openBlock(), createElementBlock("td", mergeProps({
                          key: 1,
                          ref_for: true
                        }, getTFProps(col)), [
                          ...
                          createElementVNode("div", {
                            ...
                            footRow[col.dataIndex] != null ? (openBlock(), createElementBlock("span", _hoisted_13, toDisplayString(footRow[col.dataIndex]), 1)) : createCommentVNode("", true)
                          ], 8, _hoisted_12)
                        ], 16))
                      ], 64);
                    }), 128)),
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(virtualX_columnPart), (col, _colIdx) => {
                    return openBlock(), createElementBlock(Fragment, {
                      ...
                      col.__VT_C_SP__ ? (openBlock(), createElementBlock("td", {
                        ...
                        class: "vt-x-spacer",
                        colspan: col.__VT_C_SP__
                      }, null, 8, _hoisted_14)) : (openBlock(), createElementBlock("td", {
                        key: 1,
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(bodyRenderItems.value, (item) => {
                return openBlock(), createElementBlock(Fragment, {
                  ...
                  item.type === "row" ? (openBlock(), createElementBlock("tr", mergeProps({
                    ...
                    item.row && item.row.__EXP_R__ ? (openBlock(), createElementBlock("td", {
                    ...
                    ], 8, _hoisted_15)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                      ...
                      (openBlock(true), createElementBlock(Fragment, null, renderList(getBodyColumns(item.row, item.rowIndex), (col, _colIdx) => {
                        return openBlock(), createElementBlock(Fragment, {
                          ...
                          col.__VT_C_SP__ ? (openBlock(), createElementBlock("td", {
                            ...
                            class: "vt-x-spacer",
                            colspan: col.__VT_C_SP__
                          }, null, 8, _hoisted_18)) : col.__VT_PH__ ? (openBlock(), createElementBlock("td", {
                            key: 1,
                            class: "vt-above-viewport-ph",
                            colspan: col.__VT_PH__
                          }, null, 8, _hoisted_19)) : !shouldHideCell(item.row, col) ? (openBlock(), createElementBlock("td", mergeProps({
                            key: 2,
                            ref_for: true
                            ...
                            col.customCell ? (openBlock(), createBlock(resolveDynamicComponent(col.customCell), {
                              ...
                              _: 2
                            }, 1032, ["col", "row", "rowIndex", "colIndex", "cellValue", "expanded", "tree-expanded"])) : (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList([
                              getFormattedValue(item.row, col, item.rowIndex, col.__LF_S__ ?? 0)
                            ], (text) => {
                              return openBlock(), createElementBlock(Fragment, { key: text }, [
                                !col.type ? (openBlock(), createElementBlock("div", {
                                  ...
                                  tabindex: "-1",
                                  title: text || ""
                                }, toDisplayString((item.row && text) != null ? item.row && text : getEmptyCellText.value(col, item.row)), 9, _hoisted_20)) : col.type === "seq" ? (openBlock(), createElementBlock("div", _hoisted_21, toDisplayString((props.seqConfig.startIndex || 0) + getAbsoluteRowIndex(item.rowIndex) + 1), 1)) : col.type === "selection" ? (openBlock(), createElementBlock("div", _hoisted_22, [
                                  createElementVNode("input", {
                                    type: "checkbox",
                                    checked: item.row.__isChecked,
                                    onChange: ($event) => onCellCheckboxChange(item.row)
                                  }, null, 40, _hoisted_23)
                                ])) : col.type === "tree-node" ? (openBlock(), createBlock(_sfc_main$4, {
                                  key: 3,
                                  class: "table-cell-wrapper",
                                  tabindex: "-1",
                                  col,
                                  ...
                                  text != null ? (openBlock(), createElementBlock("span", _hoisted_25, toDisplayString(text), 1)) : createCommentVNode("", true)
                                ], 8, _hoisted_24))
                              ], 64);
                            }), 128))
                      ...
                      unref(virtualX_on) ? (openBlock(), createElementBlock("td", _hoisted_26)) : createCommentVNode("", true)
                    ], 64))
                  ...
                  }, null, 12, _hoisted_27)) : (openBlock(), createElementBlock("tr", {
                    key: 2,
          ...
          return () => {
            ...
            return h(
              _sfc_main$3,
              {
                ...
                dataSource: ((_a = stkTableInstance == null ? void 0 : stkTableInstance.props) == null ? void 0 : _a.dataSource) || []
              },
