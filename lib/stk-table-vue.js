            ...
            createElementVNode("tbody", {
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(virtual_dataSourcePart), (row, rowIndex) => {
                return openBlock(), createElementBlock("tr", mergeProps({
                  ...
                  onDrop: ($event) => unref(onTrDrop)($event, getAbsoluteRowIndex(rowIndex)),
                  ...
                  row && row.__EXP_R__ ? (openBlock(), createElementBlock("td", {
                    ...
                    return openBlock(), createElementBlock(Fragment, null, [
                      !shouldHideCell(row, col) ? (openBlock(), createElementBlock("td", mergeProps({
                        ...
                        }, toDisplayString((row && row[col.dataIndex]) !== void 0 ? row && row[col.dataIndex] : getEmptyCellText.value(col, row)), 9, _hoisted_17)) : col.type === "seq" ? (openBlock(), createElementBlock("div", _hoisted_18, toDisplayString((props.seqConfig.startIndex || 0) + getAbsoluteRowIndex(rowIndex) + 1), 1)) : col.type === "tree-node" ? (openBlock(), createBlock(_sfc_main$3, {
                          key: 3,
                          class: "table-cell-wrapper",
                          tabindex: "-1",
                          col,
