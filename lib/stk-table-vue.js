                            ...
                            (openBlock(true), createElementBlock(Fragment, null, renderList([
                              ...
                              return openBlock(), createElementBlock(Fragment, { key: text }, [
                                col.customCell ? (openBlock(), createBlock(resolveDynamicComponent(col.customCell), {
                                  ...
                                  tabindex: "-1",
                                  title: text || ""
                                }, toDisplayString((item.row && item.row[col.dataIndex]) != null ? item.row && item.row[col.dataIndex] : getEmptyCellText.value(col, item.row)), 9, _hoisted_20)) : col.type === "seq" ? (openBlock(), createElementBlock("div", _hoisted_21, toDisplayString((props.seqConfig.startIndex || 0) + getAbsoluteRowIndex(item.rowIndex) + 1), 1)) : col.type === "selection" ? (openBlock(), createElementBlock("div", _hoisted_22, [
                                  createElementVNode("input", {
                                    type: "checkbox",
