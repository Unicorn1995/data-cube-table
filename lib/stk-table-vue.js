                  ...
                  return openBlock(), createElementBlock("tr", { key: footRowIndex }, [
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(virtualX_columnPart), (col) => {
                      return openBlock(), createElementBlock(Fragment, {
                        key: col.__VT_C_SP__ ? "spacer" : colKeyGen.value(col)
                      }, [
                        col.__VT_C_SP__ ? (openBlock(), createElementBlock("td", {
                          key: 0,
                          class: "vt-x-spacer",
                          colspan: col.__VT_C_SP__
                        }, null, 8, _hoisted_10)) : (openBlock(), createElementBlock("td", mergeProps({
                          key: 1,
                          ref_for: true
                        }, getTFProps(col)), [
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(virtualX_columnPart), (col) => {
                    return openBlock(), createElementBlock(Fragment, {
                      ...
                      col.__VT_C_SP__ ? (openBlock(), createElementBlock("td", {
                        ...
                        class: "vt-x-spacer",
                        colspan: col.__VT_C_SP__
                      }, null, 8, _hoisted_13)) : (openBlock(), createElementBlock("td", {
                        key: 1,
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(virtualX_columnPart), (col) => {
                      return openBlock(), createElementBlock(Fragment, {
                        ...
                        col.__VT_C_SP__ ? (openBlock(), createElementBlock("td", {
                          ...
                          key: 1,
                          ref_for: true
                        }, getTDProps(row, col, rowIndex, col.__LF_S__ ?? 0)), [
                          (openBlock(true), createElementBlock(Fragment, null, renderList([getFormattedValue(row, col, rowIndex, col.__LF_S__ ?? 0)], (text) => {
