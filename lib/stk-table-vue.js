                    ...
                    return openBlock(), createElementBlock(Fragment, null, [
                      !shouldHideCell(row, col) ? (openBlock(), createElementBlock("td", mergeProps({
                        ...
                        col.customCell ? (openBlock(), createBlock(resolveDynamicComponent(col.customCell), {
                          ...
                          row[col.dataIndex] != null ? (openBlock(), createElementBlock("span", _hoisted_23, toDisplayString(row[col.dataIndex]), 1)) : createCommentVNode("", true)
                        ], 8, _hoisted_22))
