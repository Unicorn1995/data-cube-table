 ...
 * license: MIT
 */
import { ref, computed, onMounted, onBeforeUnmount, watch, createElementBlock, openBlock, createElementVNode, defineComponent, normalizeStyle, createBlock, createCommentVNode, toDisplayString, shallowRef, nextTick, customRef, onUnmounted, toRaw, createApp, normalizeClass, provide, toRef, unref, renderSlot, Fragment, renderList, mergeProps, resolveDynamicComponent, withCtx, createTextVNode, createVNode, markRaw, getCurrentInstance, h } from "vue";
...
function useAreaSelection(props, emits, tableContainerRef, dataSourceCopy, tableHeaderLast, colKeyGen, cellKeyGen, scrollTo, virtualScroll, virtualScrollX, getRowIndex, getColumnIndex, selectionAreaOverlayRef) {
  const EDGE_ZONE = 40;
  ...
  function updateSelectionBoxStyle(ranges) {
    if (!ranges.length) {
...
function _sfc_render$2(_ctx, _cache) {
  return openBlock(), createElementBlock("span", _hoisted_1$5, [..._cache[0] || (_cache[0] = [
...
const DragHandle = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$2]]);
const _sfc_main$5 = {};
const _hoisted_1$4 = {
...
const SortIcon = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$1]]);
const _sfc_main$4 = {};
const _hoisted_1$3 = { class: "stk-fold-icon" };
function _sfc_render(_ctx, _cache) {
  return openBlock(), createElementBlock("div", _hoisted_1$3);
}
const TriangleIcon = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render]]);
...
const _hoisted_8 = { class: "table-header-title" };
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const emits = __emit;
    const selectionAreaOverlayRef = ref();
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", _hoisted_2, [
          createElementVNode("table", {
                    ...
                    return openBlock(), createElementBlock("th", mergeProps({
                      ...
                      createElementVNode("div", {
                        ...
                        col.customHeaderCell ? (openBlock(), createBlock(resolveDynamicComponent(col.customHeaderCell), {
                          ...
                          colIndex,
                          rowIndex
                        }, null, 8, ["col", "colIndex", "rowIndex"])) : col.type === "selection" ? (openBlock(), createElementBlock("div", _hoisted_6, [
                          ...
                          createElementVNode("span", _hoisted_8, toDisplayString(col.label), 1)
                        ]),
                        col.sorter ? (openBlock(), createBlock(SortIcon, {
                          key: 3,
                          class: "table-header-sorter"
                        })) : createCommentVNode("", true),
                        col.filterable ? (openBlock(), createBlock(_sfc_main$2, {
                          key: 4,
                          theme: __props.theme,
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(virtualX_columnPart), (col, colIndex) => {
                      return openBlock(), createElementBlock("td", mergeProps({
                        ...
                        createElementVNode("div", {
                          ...
                          footRow[col.dataIndex] != null ? (openBlock(), createElementBlock("span", _hoisted_12, toDisplayString(footRow[col.dataIndex]), 1)) : createCommentVNode("", true)
                        ], 8, _hoisted_11)
                      ], 16);
                    }), 128)),
            ...
            createElementVNode("tbody", {
              ...
              !isExperimentalScrollY.value && unref(virtual_on) && !unref(isSRBRActive) ? (openBlock(), createElementBlock("tr", {
                ...
                unref(virtualX_on) && __props.fixedMode && __props.headless ? (openBlock(), createElementBlock("td", _hoisted_14)) : createCommentVNode("", true),
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(virtual_dataSourcePart), (row, rowIndex) => {
                return openBlock(), createElementBlock("tr", mergeProps({
                  ...
                  row && row.__EXP_R__ ? (openBlock(), createElementBlock("td", {
                    ...
                    return openBlock(), createElementBlock(Fragment, null, [
                      !shouldHideCell(row, col) ? (openBlock(), createElementBlock("td", mergeProps({
                        ...
                        (openBlock(true), createElementBlock(Fragment, null, renderList([getFormattedValue(row, col, rowIndex, colIndex)], (text) => {
                          return openBlock(), createElementBlock(Fragment, { key: text }, [
                            col.customCell ? (openBlock(), createBlock(resolveDynamicComponent(col.customCell), {
                              ...
                              tabindex: "-1",
                              title: text || ""
                            }, toDisplayString((row && text) != null ? row && text : getEmptyCellText.value(col, row)), 9, _hoisted_18)) : col.type === "seq" ? (openBlock(), createElementBlock("div", _hoisted_19, toDisplayString((props.seqConfig.startIndex || 0) + getAbsoluteRowIndex(rowIndex) + 1), 1)) : col.type === "selection" ? (openBlock(), createElementBlock("div", _hoisted_20, [
                              createElementVNode("input", {
                                type: "checkbox",
                                checked: row.__isChecked,
                                onChange: ($event) => onCellCheckboxChange(row)
                              }, null, 40, _hoisted_21)
                            ])) : col.type === "tree-node" ? (openBlock(), createBlock(_sfc_main$3, {
                              key: 4,
                              class: "table-cell-wrapper",
                              tabindex: "-1",
                              col,
                              ...
                              text != null ? (openBlock(), createElementBlock("span", _hoisted_23, toDisplayString(text), 1)) : createCommentVNode("", true)
                            ], 8, _hoisted_22))
                          ], 64);
                        }), 128))
                  ...
                  unref(virtualX_on) ? (openBlock(), createElementBlock("td", _hoisted_24)) : createCommentVNode("", true)
                ], 16);
              }), 128)),
          ...
          createElementVNode("div", {
            ref_key: "selectionAreaOverlayRef",
            ref: selectionAreaOverlayRef,
            class: "selection-area-overlay"
          }, null, 512)
        ]),
    ...
    return markRaw(
      defineComponent({
        ...
        setup(props) {
          ...
          computed(() => (config == null ? void 0 : config.options) ?? autoOptions.value);
          function handleChange(value) {
            ...
            (_b = stkTableInstance == null ? void 0 : stkTableInstance.exposed) == null ? void 0 : _b.setFilter(filterStatus.value, option);
          }
          return () => {
            var _a;
            return h(
