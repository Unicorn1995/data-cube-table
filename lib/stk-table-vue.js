 ...
 * license: MIT
 */
import { a as insertToOrderedArray, i as binarySearch, n as registerFeature, o as strCompare, r as useAreaSelection, s as tableSort, t as StkTable_default } from "./StkTable-D6wN0wRz.js";
import { Fragment, computed, createApp, createElementBlock, createElementVNode, createTextVNode, defineComponent, getCurrentInstance, h, markRaw, nextTick, normalizeClass, openBlock, ref, renderSlot, toDisplayString, watch } from "vue";
//#region src/StkTable/custom-cells/Filter/Dropdown/index.ts
...
async function getDropdownIns() {
	if (!DropdownIns) {
		...
		DropdownIns = createApp(await import("./Dropdown-CYnezMTv.js").then((module) => module.default)).mount(div);
	}
	return DropdownIns;
}
//#endregion
//#region src/StkTable/custom-cells/Filter/Filter.vue
...
//#endregion
//#region src/StkTable/custom-cells/Filter/createFilter.ts
/**
* 从数据源提取筛选选项
*
			...
			setup(props) {
				...
				*/
				...
				const autoOptions = computed(() => {
					...
					return extractFilterOptions((stkTableInstance === null || stkTableInstance === void 0 || (_stkTableInstance$pro2 = stkTableInstance.props) === null || _stkTableInstance$pro2 === void 0 ? void 0 : _stkTableInstance$pro2.dataSource) || [], colKey);
				});
				const resolvedOptions = computed(() => (config === null || config === void 0 ? void 0 : config.options) ?? autoOptions.value);
...
//#endregion
export { StkTable_default as StkTable, binarySearch, createEditableCell, createFilter, insertToOrderedArray, registerFeature, strCompare, tableSort, useAreaSelection };
