 ...
 * license: MIT
 */
import { a as insertToOrderedArray, i as binarySearch, n as registerFeature, o as strCompare, r as useAreaSelection, s as tableSort, t as StkTable_default } from "./StkTable-BugG7a1E.js";
...
async function getDropdownIns() {
	if (!DropdownIns) {
		...
		DropdownIns = createApp(await import("./Dropdown-BIGxWVTR.js").then((module) => module.default)).mount(div);
	}
	return DropdownIns;
}
//#endregion
