 ...
 * license: MIT
 */
import { t as StkTable_default } from "./StkTable-Br7RcAo_.js";
import { createElementBlock, createElementVNode, createVNode, defineComponent, h, normalizeClass, normalizeStyle, onMounted, onUnmounted, openBlock, reactive, ref, withModifiers } from "vue";
//#endregion
//#region src/StkTable/components/Filter/Dropdown/index.vue
	...
	setup(__props, { expose: __expose }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				createElementVNode("footer", null, [createElementVNode("button", { onClick: handleClear }, "↺"), createElementVNode("button", { onClick: confirm }, "✓")])
			], 6);
		};
	}
});
